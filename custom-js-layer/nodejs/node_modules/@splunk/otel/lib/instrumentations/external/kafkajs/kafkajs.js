...
class KafkaJsInstrumentation extends instrumentation_1.InstrumentationBase {
    constructor(config = {}) {
        super('splunk-opentelemetry-instrumentation-kafkajs', version_1.VERSION, Object.assign({}, config));
    }
    setConfig(config = {}) {
    ...
    init() {
        ...
        const module = new instrumentation_1.InstrumentationNodeModuleDefinition(KafkaJsInstrumentation.component, ['*'], (moduleExports, moduleVersion) => {
            var _a, _b;
    ...
    _getConsumerEachMessagePatch() {
        ...
        return (original) => {
            return function eachMessage(...args) {
                ...
                const span = instrumentation._startConsumerSpan(payload.topic, payload.message, semantic_conventions_1.MessagingOperationValues.PROCESS, propagatedContext);
    ...
    _getConsumerEachBatchPatch() {
        return (original) => {
            ...
            return function eachBatch(...args) {
                ...
                const receivingSpan = instrumentation._startConsumerSpan(payload.batch.topic, undefined, semantic_conventions_1.MessagingOperationValues.RECEIVE, api_1.ROOT_CONTEXT);
                return api_1.context.with(api_1.trace.setSpan(api_1.context.active(), receivingSpan), () => {
                    const spans = payload.batch.messages.map((message) => {
                        ...
                        return instrumentation._startConsumerSpan(payload.batch.topic, message, semantic_conventions_1.MessagingOperationValues.PROCESS, undefined, origSpanLink);
                    });
